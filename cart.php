...
<body>
    ...
    <div class="cart-container">
        ...
        <?php if ($result->num_rows > 0) { ?>
            <table>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="cart.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('ต้องการลบสินค้านี้หรือไม่?');">
                                ❌
                            </a>
                        </td>
                    </tr>
            ...
            <br>
            <a href="cart.php?clear=true" class="clear-cart" onclick="return confirm('ต้องการลบสินค้าทั้งหมดหรือไม่?');">ล้างตะกร้าทั้งหมด</a>
        <?php } else { ?>
