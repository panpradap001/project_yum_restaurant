...
$fermented_sql = "SELECT * FROM sluttish";
        ...
        <form action="order.php" method="post">
            ...
            <div class="all-options-container">
                ...
                <div class="noodle-options">
                    ...
                    ?>
                        <label>
                            <input type="radio" name="noodle" value="<?php echo $noodle_name; ?>" required> <!-- เพิ่ม required -->
                ...
                <div class="spicy-options">
                    ...
                    ?>
                        <label>
                            <input type="radio" name="spicy" value="<?php echo $spicy_name; ?>" required> <!-- เพิ่ม required -->
                ...
                <div class="fermented-options">
                    ...
                    ?>
                        <label>
                            <input type="radio" name="fermented_fish" value="<?php echo $fermented_name; ?>" required> <!-- เพิ่ม required -->
                ...
                <div class="pachana-options">
                    ...
                    ?>
                        <label>
                            <input type="radio" name="pachana" value="<?php echo $pachana_name; ?>" required> <!-- เพิ่ม required -->
                ...
                <div class="topping-options">
                    ...
                    ?>
                        <label>
                            <input type="checkbox" name="topping[]" value="<?php echo htmlspecialchars($topping['name']); ?>">
